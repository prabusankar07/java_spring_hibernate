...
<s:form action="LabRequestSearch" commandName="lb" method="post">
<s:input type="text" name="searchid" placeholder="LabID" path="labId"></s:input>
<input type="submit" value="searchlab" name="req"/>

</s:form>
<s:form action="LabRequestEntry" commandName="lb" method="post">
<fieldset>
...
<tr>
<td><b>Lab ID</b></td>
<td><s:input type="text" name="labID" value="${ldb.labId}" path="labId"></s:input></td>
</tr>
<tr>
<td><b>Location</b></td>
<td><s:input type="text" list="cities" name="city" value="${ldb.city}" path="location"  />
...
<td><s:input type="text" name="training" path="trainingName"></s:input></td>
</tr>
<tr>
<td><b>LO Name</b></td>
<td><s:input type="text" name="loName" path="loName"></s:input></td>
</tr>
<tr>
<td><b>Start Date</b></td>
<td><s:input type="date" name="sdate" path="startDate"></s:input></td>
</tr>
<tr>
<td><b>End Date</b></td>
<td><s:input type="date" name="edate" path="endDate"></s:input></td>
</tr>
<tr>
<td><b></b></td>
<td></td>
