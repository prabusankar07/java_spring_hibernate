...
<s:form  action="LabReleaseRequestSearch" commandName="lb1" method="post">
<s:input type="text" name="bookingID" placeholder="BookingId"  path="bookingId"></s:input>
<input type="submit" value="searchlab" name="req"/>
</s:form>
<s:form action="LabReleaseRequestEntry" commandName="lb1" method="post">
<fieldset>
...
<td><s:input type="text" name="bookingID" id="bookid" onclick="myFun()" path="bookingId"/></td>
</tr>
<tr>
<td><b>Lab ID</b></td>
...
<td><s:input type="date" name="reldate" path="releaseDate"></s:input></td>
</tr>
<tr>
<td><b></b></td>
</tr>
