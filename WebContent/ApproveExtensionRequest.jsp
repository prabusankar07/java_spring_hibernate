...
<s:form action="LabExtensionRequestEntryApprove" commandName="lb" method="post">
<fieldset>
...
<tr>
<td><b>End Date</b></td>
<td><s:input  path="endDate" value="${ldb.endDate}" readonly="true"></s:input></td>
</tr>
<tr>
<td><b>Extension Date</b></td>
<td><s:input  path="extensionDate" value="${ldb.extensionDate}" readonly="true"></s:input></td>
</tr>
<tr>
<td><b>Approval</b></td>
