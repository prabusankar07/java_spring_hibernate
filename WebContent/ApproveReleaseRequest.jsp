...
<s:form action="LabReleaseRequestEntryApprove" commandName="lb" method="post">
<fieldset>
...
<td><s:input  name="sdate" path="startDate" value="${ldb.startDate}" readonly="true"></s:input></td>
</tr>
<tr>
<td><b>End Date</b></td>
...
<td><s:input name="redate" path="releaseDate" value="${ldb.releaseDate}" readonly="true"></s:input></td>
</tr>
<tr>
<td><b>Approval</b></td>
