...
<div id="detail">
<s:form action="ApproveExtensionRequest" name="myForm" commandName="lb" method="post">
<fieldset>
...
<th>Approve</th>
  ...
  <tr>
   ...
   <td> ${lerb.extensionDate } </td>
    <td> ${lerb.approval } </td>
     <td><a id="req" href="/LMS/ApproveExtensionRequest?value=${lerb.bookingId} ">approve/deny</a> </td>
   </tr>
  </c:forEach>
